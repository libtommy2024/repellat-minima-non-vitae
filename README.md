# @libtommy2024/repellat-minima-non-vitae

A fluent API to generate JSON schemas (draft-07) for Node.js and browser. Framework agnostic.

[![view on npm](https://img.shields.io/npm/v/@libtommy2024/repellat-minima-non-vitae.svg)](https://www.npmjs.org/package/@libtommy2024/repellat-minima-non-vitae)
[![](https://github.com/libtommy2024/repellat-minima-non-vitae/workflows/ci/badge.svg)](https://github.com/libtommy2024/repellat-minima-non-vitae/actions?query=workflow%3Aci)
[![Coverage Status](https://coveralls.io/repos/github/fastify/@libtommy2024/repellat-minima-non-vitae/badge.svg?branch=master)](https://coveralls.io/github/fastify/@libtommy2024/repellat-minima-non-vitae?branch=master)
...
## Install
    ...
    npm i @libtommy2024/repellat-minima-non-vitae

or

    yarn add @libtommy2024/repellat-minima-non-vitae

## Usage

```javascript
const S = require('@libtommy2024/repellat-minima-non-vitae')
...
```typescript
import S from '@libtommy2024/repellat-minima-non-vitae'
...
```typescript
import * as S from '@libtommy2024/repellat-minima-non-vitae'
